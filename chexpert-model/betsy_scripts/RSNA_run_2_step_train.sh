...
#use this script to run bias amplification for indirect approaches (#1a, 1b, 1c)
...
TASK_2=Yes
R=reverse
declare -a LAYER_ARRAY=("last_17" "last_6" "last_4" "last_3")
for BATCH in 0
do
...
python ../train.py --ckpt_path ${BASE_WEIGHTS} \
                   ...
                   --train_custom_csv ${MAIN_DIR}/RAND_${RAND}/train.csv \
                   --val_custom_csv ${MAIN_DIR}/RAND_${RAND}/validation.csv \
                   --save_dir ${MAIN_DIR}/RAND_${RAND}/source_model_${R} \
                   --experiment_name ${EXPERIMENT_NAME} \
                   --batch_size 48 \
                   --iters_per_print 1632 \
                   --iters_per_visual  79824 \
...
python ../train.py --ckpt_path ${MAIN_DIR}/RAND_${RAND}/source_model_${R}/${BASE_WEIGHTS}_subgroup_size_decay_30_lr_5e-5/best.pth.tar \
                   --moco False \
                   --dataset custom \
                   --train_custom_csv ${MAIN_DIR}/RAND_${RAND}/train.csv \
                   --val_custom_csv ${MAIN_DIR}/RAND_${RAND}/validation.csv \
                   --save_dir ${MAIN_DIR}/RAND_${RAND}/target_model_${R}_${LAYER}_RD_${RANDOM_STATE} \
                   --experiment_name ${EXPERIMENT_NAME} \
                   --batch_size 48 \
                   --iters_per_print 1632 \
                   --iters_per_visual  79824 \
