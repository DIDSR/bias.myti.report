...
def divide_validation(input_file=validation_file, sizes=split_sizes, stratification_subgroups=strat_groups, reduce_by=reduction_groups, random_state=0):
    # set up
    ...
    for size in sizes:
        ...
        split_fp = input_file.replace("validation.csv", f"_{split_id}_validation.csv")
