...
# # Notes
# # To check what repos the code works for, look at the "repo" choices in the parser below
...
def get_repo(args):
    if args.betsy:
        ...
        summary_json = f"/scratch/alexis.burgon/2022_CXR/data_summarization/20221010/summary_table__{args.repo}.json"
        ...
        summary_json = f"/gpfs_projects/ravi.samala/OUT/2022_CXR/data_summarization/20221023/20221023_summary_table__{args.repo}.json"
        img_save_loc = f"/gpfs_projects/ravi.samala/OUT/2022_CXR/data_summarization/20221023/20221023_{args.repo}_jpegs"
...
def convert_dicom_to_jpeg(args):
    ...
    for i in img_info:
        ...
        rows = dcm.Rows
        columns = dcm.Columns
        crop_image = adjusted_image[round(rows*args.top):round(rows*args.bottom), round(columns*args.left):round(columns*args.right)]
        # save image
...
if __name__ == '__main__':
    ...
    parser.add_argument('-r', '--repo', required=True,
                        choices=['open_A1','open_R1','MIDRC_RICORD_1C',
    ...
    convert_dicom_to_jpeg_parallel(args)
    print("\nDONE\n")
