...
class CustomDataset(BaseDataset):
    def __init__(self, csv_name, is_training, study_level,
        ...
        if self.is_train_dataset:
            ...
            self.csv_path = '/gpfs_projects/ravi.samala/OUT/moco/reorg_chexpert/moving_logs/fine_tune_train_log.csv'  # # RKS
            # self.csv_path = '/gpfs_projects/ravi.samala/OUT/moco/reorg_chexpert/moving_logs/valid_log.csv'  # # RKS
            # self.csv_path = '/gpfs_projects/ravi.samala/OUT/moco/reorg_chexpert/moving_logs/test_log.csv'  # # RKS
