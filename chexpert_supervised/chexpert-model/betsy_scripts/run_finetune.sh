...
cd "$(dirname "$0")"
MAIN_DIR=/scratch/ravi.samala/2022_CXR/model_runs/20220902
RAND=1
OPTION=0
REPO=MIDRC_RICORD_1C
EPOCHS=500
FINETUNE=last_03    # # options: full, last_12, last_06, last_01, last_03

# last layer: module.fc.weight,module.fc.bias
python /home/ravi.samala/code/rsync_dirs/mycode/Moco_CXR_decision_boundary/chexpert_supervised/chexpert-model/train.py --ckpt_path /scratch/alexis.burgon/2022_CXR/model_runs/moco_checkpoints/checkpoint_0019.pth.tar \
                   --dataset custom \
